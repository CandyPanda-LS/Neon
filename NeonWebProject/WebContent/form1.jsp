                                ...
                                <div class="basic-form">
                                    <form action="Contact_us" method="POST" >
                                        <div class="form-group">
                                            <input type="text" class="form-control input-flat" name="Name" placeholder="Name "><br/>
                                            <input type="text" class="form-control input-flat" name="Email" placeholder="Email"><br/>
