								...
								<div class="compose-content mt-5">
									<form action="insertPhotos" method="post"
										...
										<div class="form-group">
											<input type="text" name="name" class="form-control bg-transparent" placeholder=" Title" required>
										</div>
										<div class="form-group">
											<textarea name="description" class="textarea_editor form-control bg-light" rows="15" placeholder="Enter text ..." required></textarea>
										</div>
